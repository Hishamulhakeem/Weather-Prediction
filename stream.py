...
if prediction_made or 'formatted_results' in locals():
    ...
    if location == "Austin" and formatted_results:
        st.markdown(f"<div class='weather-metric'>Predicted Max Temperature/ Feels Like: <b>{formatted_results.get('max_temp', '29.42°C')}</b></div>", unsafe_allow_html=True)
